...
using System.Text;
    ...
    public class PasswordNetworkManager : MonoBehaviour
    {
        ...
        public void Host()
        {
            ...
            NetworkManager.Singleton.StartHost(new Vector3(1.7f, 0f, 182.9f), Quaternion.Euler(0f, 135f, 0f));
        }
        ...
        private void ApprovalCheck(byte[] connectionData, ulong clientId, MLAPI.NetworkManager.ConnectionApprovedDelegate callback)
        {
            ...
            {
                case 1:
                    spawnPos = new Vector3(1.7f, 0.304f, 182.9f);
                    spawnRot = Quaternion.Euler(0f, 180f, 0f);
                    break;
                case 2:
                    spawnPos = new Vector3(1.7f, 0f, 182.9f);
